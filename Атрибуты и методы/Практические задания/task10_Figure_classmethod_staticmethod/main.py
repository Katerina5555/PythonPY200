...
if __name__ == '__main__':
    # print(TriangleCalculator().area())  # Работаем через экземпляр
    print(TriangleCalculator.area(5, 10))  # Работаем через экземпляр

    # print(TriangleCalculator.area())  # Работаем через класс
    print(TriangleCalculator.area(5, 10, 5))  # Работаем через класс
